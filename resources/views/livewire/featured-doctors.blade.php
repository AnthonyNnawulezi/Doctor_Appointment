    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-card border border-card-line">
            ...
            <div class="mt-3 space-x-1">
                <a class="inline-flex justify-center items-center size-8 text-sm font-semibold rounded-lg bg-layer border border-layer-line text-muted-foreground-1 hover:bg-muted-hover focus:outline-hidden focus:bg-muted-focus disabled:opacity-50 disabled:pointer-events-none"
                    href="#">
        ...
        <a class="col-span-full lg:col-span-1 group flex flex-col justify-center text-center rounded-xl p-4 md:p-6 bg-layer border border-dashed border-layer-line hover:shadow-2xs focus:outline-hidden focus:shadow-2xs"
            href="#">
            ...
            <div>
                <span
                    class="inline-flex items-center gap-x-2 text-primary group-hover:text-primary-hover group-focus:text-primary-focus">
