    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
            <h1 class="block text-3xl font-bold text-foreground sm:text-4xl lg:text-6xl lg:leading-tight">Start your
                journey with <span class="text-primary">Preline</span></h1>
            <p class="mt-3 text-lg text-foreground">Hand-picked professionals and expertly crafted components, designed
                for any kind of entrepreneur.</p>
        ...
        <div class="relative ms-4">
            <img class="w-full rounded-md" src={{ asset('doc.jpg') }} alt="Hero Image">
            <div
