                        ...
                        <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                            <div>
                                <h1
                                    ...
                                    Start your journey with <span class="text-primary">Preline</span></h1>
                                <p class="mt-3 text-lg text-foreground">Hand-picked professionals and expertly crafted
                                ...
                                <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                                    ...
                                    <div class="py-5">
                                        <div class="flex gap-x-1">
                                            <svg class="size-4 text-foreground" width="51" height="51"
                                        ...
                                        <div class="mt-5">
                                            <!-- Star -->
                                            <svg class="h-auto w-16 text-foreground" width="80" height="27"
                                                viewBox="0 0 80 27" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="relative ms-4">
                                ...
                                <div class="absolute bottom-0 inset-s-0">
                                    <svg class="w-2/3 ms-auto h-auto text-white dark:text-neutral-900" width="630"
