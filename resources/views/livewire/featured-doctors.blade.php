...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
        <h2 class="text-2xl font-bold md:text-4xl md:leading-tight text-foreground">Our leadership</h2>
        <p class="mt-1 text-muted-foreground-2">Creative people</p>
    </div>
    <!-- End Title -->
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
            ...
            <div class="mt-3 space-x-1">
                <a class="inline-flex justify-center items-center size-8 text-sm font-semibold rounded-lg bg-white border border-gray-200 text-gray-700 hover:bg-gray-100 focus:outline-none
                hover:text-blue-600 focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none"
                    href="#">
                ...
                <button type="button"
                    class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg bg-blue-600 border border-[#d4b896] text-secondary-foreground hover:bg-[#d4b896] focus:outline-none focus:bg-[#d4b896] disabled:opacity-50 disabled:pointer-events-none">
                    Book Appointment
                </button>
            </div>
            <!-- End Social Brands -->
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-card border border-card-line">
            <div class="flex items-center gap-x-4">
                <img class="rounded-full size-20"
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-card border border-card-line">
            ...
            <div class="mt-3 space-x-1">
                ...
                <a class="inline-flex justify-center items-center size-8 text-sm font-semibold rounded-lg bg-white border border-gray-300 text-gray-700 hover:bg-gray-100 focus:outline-none
                hover:text-blue-600 focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none"
        ...
        <a
            class="col-span-full lg:col-span-1 group flex flex-col justify-center text-center rounded-xl p-4 md:p-6 bg-white border border-dasgray-200-layer-line hover:shadow-2xs focusgray-100dden focus:shadow-2xs"gray-100">
            <h3 class="text-lg text-gray-700 hover:text-blue-600">
                See more Doctors!
            </h3>
            <div>
                <span
                    class="inline-flex items-center gap-x-2 text-gray-500
                    hover:text-blue-600 group-hover:text-primary-hover group-focus:text-primary-focus">
                    Search for More...
