...
use App\Livewire\EditSpeciality;
...
Route::group(['middleware' => 'admin'], function () {
    ...
    Route::get('/admin/edit/{ $speciality_id }/speciality', [EditSpeciality::class, 'editSpeciality'])->name('admin.edit-speciality');
    Route::get('/admin/delete/{ $speciality_id }/speciality', [EditSpeciality::class, 'deleteSpeciality'])->name('admin.delete-speciality');
});
