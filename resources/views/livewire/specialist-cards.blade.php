...
<div class="max-w-340 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="max-w-2xl text-center mx-auto mb-10 lg:mb-14">
        <h2 class="text-2xl font-bold md:text-4xl md:leading-tight text-foreground">Specialist Doctors</h2>
        <p class="mt-1 text-muted-foreground-2">We've helped some great people receive great treatment faster and
            effectively.</p>
    </div>
    <!-- End Title -->
    <!-- Grid -->
        ...
        <a class="group block rounded-xl overflow-hidden focus:outline-hidden" href="#">
            <div class="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5">
                <div class="shrink-0 relative rounded-xl overflow-hidden w-full sm:w-56 h-44">
                    <img class="group-hover:scale-105 group-focus:scale-105 transition-transform duration-500 ease-in-out size-full absolute top-0 inset-s-0 object-cover rounded-xl"
                ...
                <div class="grow">
                    <h3 class="text-xl font-semibold text-foreground group-hover:text-muted-foreground-2">
                        Studio by Preline
                    </h3>
                    ...
                    <p
                        class="mt-4 inline-flex items-center gap-x-1 text-sm text-primary decoration-2 group-hover:underline group-focus:underline font-mediumtext-primary decoration-2 group-hover:underline group-focus:underline font-medium">
                        Read more
